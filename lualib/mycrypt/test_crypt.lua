...
local function test_hex()
  ...
  -- 测试hexencode编码
  print("测试hexencode", crypt.hexencode("1234567890"), crypt.hexencode("1234567890") == "31323334353637383930")
  -- 测试hexdecode编码
  print("测试hexdecode", crypt.hexdecode("31323334353637383930"), crypt.hexdecode("31323334353637383930") == "1234567890")
...
local function test_crc()
  ...
  -- 测试crc32编码
  print("测试crc32",crypt.crc32("admin"))
  -- 测试crc64编码
  print("测试crc64", crypt.crc64("admin"))
...
local function test_url( ... )
  ...
  print("测试urlencode: " .. crypt.urlencode(url))

  print("测试urlencode: " .. crypt.urldecode(crypt.urlencode(url)))
...
local function test_sha()
  ...
  print("测试sha512 :" .. crypt.sha512(text, true))
...
local function test_hmac()
  ...
  assert(crypt.hmac_sha512(key, text, true) == "346b81fb7771816ad1206d996de063859e8225d09a74776ded859d1e3e388b34aae09636c5c60b2ad7d88f5518483cc3d952753573b856aab4b96531a3cb4094", "HMAC_SHA512测试失败")
    ...
    -- 测试hmac64编码
  print("hmac64", crypt.hmac64("12345678", "abcdefgh", true))

  -- 测试hmac64_md5编码
  print("hmac64_md5", crypt.hmac64_md5("12345678", "abcdefgh", true))

  -- 测试hmac_hash编码
  print("hmac_hash", crypt.hmac_hash("12345678", "abcdefgh", true))
...
local function test_des( ... )
  ...
  -- 测试desencode编码
  print("测试desencode", crypt.desencode(key, text, true))
  -- 测试desdecode编码
  print("测试desdecode", crypt.desdecode(key, crypt.desencode(key, text)) == text)
...
local function test_other( ... )
  ...
  -- 测试randomkey编码
  print("测试randomkey", crypt.randomkey(true))

  -- 测试hashkey编码
  print("测试hashkey", crypt.hashkey("admin", true))
...
local function test_xor_str( ... )
  ...
  print( "xor data = " .. crypt.hexencode(xor), "raw data = " .. raw)
...
local function test_b64()
  ...
  print(nb, ub)
  print(assert(text == txt2), assert(text == txt1), assert(txt1 == txt2))
  ...
  print(1, v, assert(v == base64decode(b1)))
  print(2, v, assert(v == base64decode(b2)))
  print(3, v, assert(v == base64decode(b3)))
  ...
  print(1, t1, assert(v1 == v2), assert(t1 == v1), assert(t1 == v2))

  v1, v2 = base64decode("QUI="), base64decode("QUI")
  print(2, t2, assert(v1 == v2), assert(t2 == v1), assert(t2 == v2))

  v1, v2 = base64decode("QUJD"), base64decode("QUJD")
  print(3, t3, assert(v1 == v2), assert(t3 == v1), assert(t3 == v2))

  v1, v2 = base64decode("QUJDRA=="), base64decode("QUJDRA")
  print(4, t4, assert(v1 == v2), assert(t4 == v1), assert(t4 == v2))

  v1, v2 = base64decode("QUJDREU="), base64decode("QUJDREU")
  print(5, t5, assert(v1 == v2), assert(t5 == v1), assert(t5 == v2))

  v1, v2 = base64decode("QUJDREVG"), base64decode("QUJDREVG")
  print(6, t6, assert(v1 == v2), assert(t6 == v1), assert(t6 == v2))

  v1, v2 = base64decode("QUJDREVGRw=="), base64decode("QUJDREVGRw")
  print(7, t7, assert(v1 == v2), assert(t7 == v1), assert(t7 == v2))

  v1, v2 = base64decode("QUJDREVGR0g="), base64decode("QUJDREVGR0g")
  print(8, t8, assert(v1 == v2), assert(t8 == v1), assert(t8 == v2))

  v1, v2 = base64decode("QUJDREVGR0hJ"), base64decode("QUJDREVGR0hJ")
  print(9, t9, assert(v1 == v2), assert(t9 == v1), assert(t9 == v2))
  ...
  print(base64decode(bdata1), base64decode(ubdata1))
  ...
  print(base64decode(bdata2), base64decode(ubdata2))
  ...
  print(c1, c2)
  print(assert(base64decode(c1) == test), assert(base64urldecode(c2) == test))
  -- 去除paddding测试
...
local function test_aes()
  ...
  local function test_aes_128_bit()
    ...
    print("测试aes_128_ecb_encrypt: " .. crypt.hexencode(ecb_encryptData))
    ...
    print("测试aes_128_cbc_encrypt: " .. crypt.hexencode(cbc_encryptData))
  ...
  local function test_aes_192_bit()
    ...
    print("测试aes_192_ecb_encrypt: " .. crypt.hexencode(ecb_encryptData))
    assert(ecb_rawData == text, "aes加密/解密失败")
    ...
    print("测试aes_192_cbc_encrypt: " .. crypt.hexencode(cbc_encryptData))
    assert(cbc_rawData == text, "aes加密/解密失败")
  end
  ...
  local function test_aes_256_bit()
    ...
    print("测试aes_256_ecb_encrypt: " .. crypt.hexencode(ecb_encryptData))
    assert(ecb_rawData == text, "aes加密/解密失败")
    ...
    print("测试aes_256_cbc_encrypt: " .. crypt.hexencode(cbc_encryptData))
    assert(cbc_rawData == text, "aes加密/解密失败")
  end
...
local function test_rsa()
  ...
  local function test_rsa_1024 ( ... )
    ...
    local publick_key_path = "lualib/crypt/pem/public1024.pem"
    local private_key_path = "lualib/crypt/pem/private1024.pem"
  ...
  local function test_rsa_2048( ... )
      ...
      local publick_key_path = "lualib/crypt/pem/public2048.pem"
      local private_key_path = "lualib/crypt/pem/private2048.pem"
  ...
  local function test_rsa_4096( ... )
      ...
      local publick_key_path = "lualib/crypt/pem/public4096.pem"
      local private_key_path = "lualib/crypt/pem/private4096.pem"
  ...
  local function test_rsa_sign_and_rsa_verify(...)
    ...
    local public_1024 = "lualib/crypt/pem/public1024.pem"
    local private_1024 = "lualib/crypt/pem/private1024.pem"
    
    local public_2048 = "lualib/crypt/pem/public2048.pem"
    local private_2048 = "lualib/crypt/pem/private2048.pem"

    local public_4096 = "lualib/crypt/pem/public4096.pem"
    local private_4096 = "lualib/crypt/pem/private4096.pem"
...
local function test_uuid( ... )
  ...
  print("生成的UUID为: " .. crypt.uuid())

  print("生成的GUID为: " .. crypt.guid())
